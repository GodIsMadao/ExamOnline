...
public final class aside_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if(s!=null){
      ...
      out.write("    <h3 class=\"column-title\" style=\"cursor:pointer\" id=\"selected1\">\r\n");
      out.write("      <span>试卷</span>\r\n");
      out.write("    </h3>\r\n");
      out.write("    <li class=\"column\"><a href=\"javascript:void(0)\" onclick=\"$('#content').load('");
      out.print(request.getContextPath());
      out.write("/student/papers/writen')\">已做试卷</a></li>\r\n");
      out.write("    <li class=\"column\"><a href=\"javascript:void(0)\" onclick=\"$('#content').load('");
      out.print(request.getContextPath());
      out.write("/student/papers/unwriten')\">待做试卷</a></li>\r\n");
      out.write("    <li class=\"column\"><a  href=\"javascript:void(0)\" onclick=\"$('#content').load('");
      out.print(request.getContextPath());
      out.write("/student/listScoreFS/");
      ...
      out.write("    <li class=\"column\"><a href=\"javascript:void(0)\" onclick=\"$('#content').load('");
      out.print(request.getContextPath());
      out.write("/student/questions/writen')\">已做问题</a></li>\r\n");
      out.write("    <li class=\"column\"><a href=\"javascript:void(0)\" onclick=\"$('#content').load('");
      out.print(request.getContextPath());
      out.write("/student/questions/right')\">已做对问题</a></li>\r\n");
      out.write("    <li class=\"column\"><a href=\"javascript:void(0)\" onclick=\"$('#content').load('");
      out.print(request.getContextPath());
      out.write("/student/questions/wrong')\">错题集</a></li>\r\n");
      out.write("  </ul>\r\n");
      out.write("  <ul class=\"columnMenu\">\r\n");
      out.write("    <h3 class=\"column-title\" style=\"cursor:pointer\">\r\n");
      ...
      out.write("\r\n");
      out.write("  <ul class=\"columnMenu selected\" >\r\n");
      out.write("    <h3 class=\"column-title\" id=\"selected2\">\r\n");
      out.write("      <span>试卷</span>\r\n");
      out.write("    </h3>\r\n");
      out.write("    <li class=\"column\"><a href=\"javascript:void(0)\" onclick=\"$('#content').load('");
      out.print(request.getContextPath());
      out.write("/teacher/showReleasedPaper')\">已发布试卷</a></li>\r\n");
      out.write("    <li class=\"column\"><a href=\"javascript:void(0)\" onclick=\"$('#content').load('");
      out.print(request.getContextPath());
      out.write("/teacher/showUnReleasedPaper')\">待发布试卷</a><br></li>\r\n");
      out.write("    <li class=\"column\"><a href=\"javascript:void(0)\" onclick=\"$('#content').load('");
      out.print(request.getContextPath());
      out.write("/teacher/showUnpassPaper')\">审核未通过试卷</a><br></li>\r\n");
      out.write("    <li class=\"column\"><a href=\"javascript:void(0)\" onclick=\"$('#content').load('");
      out.print(request.getContextPath());
      out.write("/teacher/add')\">新增试卷</a></li>\r\n");
      out.write("  </ul>\r\n");
      out.write("  <ul class=\"columnMenu\">\r\n");
      ...
      out.write("\r\n");
      out.write("    <ul class=\"columnMenu selected\" >\r\n");
      out.write("      <h3 class=\"column-title\" id=\"selected3\">\r\n");
