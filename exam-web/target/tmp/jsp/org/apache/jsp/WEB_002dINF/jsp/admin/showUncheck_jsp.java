...
public final class showUncheck_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("    <thead>\r\n");
      out.write("      <tr style=\"font-size: 20px;border: 1px solid rgba(77, 255, 39, 0.57)\">\r\n");
      out.write("        <td>编号</td>\r\n");
      out.write("        <td>试卷名</td>\r\n");
      out.write("        <td>介绍</td>\r\n");
      ...
      _jspx_th_c_forEach_0.setItems((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${uncheck_papers.datas}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
      ...
      try {
        ...
        if (_jspx_eval_c_forEach_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            out.write("\" style=\"border: 1px solid rgba(77, 255, 39, 0.57)\">\r\n");
            out.write("          <td>");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${count}", java.lang.String.class, (PageContext)_jspx_page_context, null));
            out.write("</td>\r\n");
            out.write("          <td>");
            ...
            out.write("</td>\r\n");
            out.write("          <td><em><a href=\"javascript:void(0)\"\r\n");
            out.write("                     onclick=\"$(this).parent().parent().parent().fadeTo(900,0.2,function(){$('#content').load('");
            out.print(request.getContextPath());
            out.write("/admin/updateCheckStatusPass/");
            ...
            out.write("')}).hide(900)\"\r\n");
            out.write("                     id=\"pass\" class=\"btn btn-success\">审核通过</a></em></td>\r\n");
            out.write("          <td>or</td>\r\n");
            out.write("          <td><span><a href=\"javascript:void(0)\" onclick=\"$(this).parent().parent().fadeTo(900,0.2,function(){$('#content').load('");
            out.print(request.getContextPath());
            out.write("/admin/updateCheckStatusUnpass/");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${paper.id}", java.lang.String.class, (PageContext)_jspx_page_context, null));
            out.write("')}).hide(900)\" id=\"unpass\" class=\"btn btn-default\">审核不通过</a></span></td>\r\n");
            out.write("        </tr>\r\n");
            out.write("      ");
      ...
      out.write("  $(function() {\r\n");
      out.write("    function click_func(){\r\n");
      out.write("    $('#body').find('em').each(function () {\r\n");
      out.write("      $(this).children(\"a\").click(function () {\r\n");
      out.write("        $(this).parent().parent().parent().fadeIn(900,0.2);\r\n");
      out.write("        $(this).parent().parent().parent().hide(1000);\r\n");
      out.write("      });\r\n");
      out.write("    })\r\n");
      out.write("    $('#body').find('span').each(function () {\r\n");
      out.write("      $(this).children(\"a\").click(function () {\r\n");
      out.write("        $(this).parent().parent().parent().fadeIn(900,0.2);\r\n");
      out.write("        $(this).parent().parent().parent().hide(1000);\r\n");
      out.write("      });\r\n");
