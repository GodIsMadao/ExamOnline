...
<div class="container">
    <div class="col-md-offset-3 col-md-6">
        <section class="panel wrapper-md">
            <header class="panel-heading text-center bg-primary"> 登入 </header>
            <form method="post" id="teacherLogin" action="" id="loginForm" >
                ...
                <div>
                    <button type="submit" class="btn btn-primary center-block">教师登陆</button>
                </div>
                </dl>
            </form>
        </section>
