...
<div class="col-md-offset-3 col-md-6">
    <section class="panel wrapper-md">
        <header class="panel-heading text-center bg bg-success"> 登入 </header>
        <form method="post" id="studentLogin" action="" id="loginForm" >
            <div class="form-group">
                <input type="text" class="form-control" autocomplete="off" placeholder="Enter username" name="username"/>
            </div>
            <div class="form-group">
                <input type="password" name="password" class="form-control" placeholder="Enter password"/>
            </div>
            <div class="form-group">
                 <input type="text" name="checkcode" autocomplete="off" id="validateCode"  class="form-control" placeholder="Enter checkcode" size="15"/>
                    ${error}
            </div>
            <div >
             ...
             <div>
                 <button type="submit" class="btn btn-success center-block">学生登陆</button>
             </div>
            </dl>
        </form>
    </section>
