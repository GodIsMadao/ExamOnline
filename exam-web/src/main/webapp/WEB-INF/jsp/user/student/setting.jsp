        ...
        <div class="panel-body">
          <div class="tab-content">
            <div id="profile" class="tab-pane active">
              <form style="width:300px" id="studentSetting" action="<%=request.getContextPath()%>/student/updateself/${loginStudent.id}" method="post" enctype="multipart/form-data">
                <div class="form-group">
                  <label class="control-label" for="id_username">用户名</label>
                  <input id="id_username" class="form-control" type="text" value="${loginStudent.username}"
                ...
                <div class="form-group">
                  <label class="control-label" for="id_teacher">老师</label>
                  <select id="id_teacher" class="form-control" name="teacher_name">
