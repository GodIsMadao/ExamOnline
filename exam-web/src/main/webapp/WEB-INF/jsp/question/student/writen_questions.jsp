...
<div class="container-fluid" style="margin-top:15px">
  <table class="panel col-md-12 text-center">
    <thead>
    <tr class="text-primary" style="font-size: 20px;border: 1px solid rgba(102, 255, 43, 0.49);">
      <td>编号</td>
      <td>所属试卷</td>
      <td>编题老师</td>
      <%--<td>所得分数</td>--%>
    ...
    <tbody >
    <c:forEach items="${stuQueWriten.datas}" var="questions" varStatus="vs">
      <c:set value="${vs.count}" var="count"></c:set>
      <tr style="border: 1px solid rgba(102, 255, 43, 0.49);">
        ...
        <td><a href="<%=request.getContextPath()%>/question/${questions.id}" class="btn btn-success">查看试题情况</a></td>
      </tr>
    </c:forEach>
    </tbody>
    <tfoot>
    <tr>
      <td colspan="6" style="text-align:right;margin-right:10px;">
        <jsp:include page="/resources/jsp/pager.jsp">
          <jsp:param value="${stuQueWriten.total }" name="totalRecord"/>
          <jsp:param value="questions/writen" name="url"/>
        </jsp:include>
      </td>
    </tr>
    </tfoot>
